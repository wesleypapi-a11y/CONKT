      ...
      <div className="min-h-screen bg-gray-50 flex">
        ...
        >
          <div className="h-full flex flex-col">
            <div className="p-6 pb-12 flex items-center justify-center border-b border-white/10 relative">
              {sidebarOpen && (
                <img
            ...
            {sidebarOpen && (
              <div className="px-4 py-4 pb-8 border-b border-white/10">
            ...
            <nav className="flex-1 p-3 pt-8 overflow-y-auto scrollbar-hide">
